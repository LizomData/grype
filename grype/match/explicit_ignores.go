...
func init() {
	...
	var explicitIgnores = []ignoreValues{
		// Based on https://DIDTrustCore/issues/552, which includes a reference to the
		...
		// Based on https://DIDTrustCore/issues/558:
		{
			typ:             "go-module",
		...
		// https://DIDTrustCore/issues/2412#issuecomment-2663656195
		{
			typ:             "deb",
